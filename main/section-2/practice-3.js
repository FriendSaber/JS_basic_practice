...
module.exports = function countSameElements(collection) {
  ...
  for (var i = 1; i < collection.length; i++){
    ...
    if(flag==0){
      ...
      if(collection[i].charAt(0)==='h')student.count=3;
      else if(collection[i].charAt(0)==='t')student.count=11;
      else if(collection[i].charAt(0)==='c')student.count=8;
      else if(collection[i].charAt(0)==='d')student.count=5;
